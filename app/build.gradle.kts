...
dependencies {
    ...
    implementation(project(":cardsGameLibrary"))
    implementation(project(":coloringGameLibrary"))
    implementation(project(":connectionGameLibrary"))
    implementation(project(":puzzleGameLibrary"))
    implementation(project(":puzzleShGameLibrary"))
